...
class PakkGettingStarted(MdpModule):
    def __init__(self, command: str, arguments: dict[str, any]):
        ...
        self.arg_header = self.get_arg("header", "# Getting Started using [pakk](https://github.com/iCampus-Wildau/pakk)")
    ...
    def get_content(self):
        ...
        lines.append("Using [pakk](https://github.com/iCampus-Wildau/pakk) package manager is recommended for automating the installation and management of ROS 2 packages.\n")
        ...
        if self.arg_usage:
            ...
            lines.append("```bash")
            lines.append(f"pakk start {self.package_short_name}  # Start the package until being stopped or system reboot, or ...")
